 ...
 */
final class Version20231115150130 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE categorie_topic (id INT AUTO_INCREMENT NOT NULL, categorie VARCHAR(50) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE post_seance (post_id INT NOT NULL, seance_id INT NOT NULL, INDEX IDX_EF5F196B4B89032C (post_id), INDEX IDX_EF5F196BE3797A94 (seance_id), PRIMARY KEY(post_id, seance_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user_seance (user_id INT NOT NULL, seance_id INT NOT NULL, INDEX IDX_BA2FE633A76ED395 (user_id), INDEX IDX_BA2FE633E3797A94 (seance_id), PRIMARY KEY(user_id, seance_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE post_seance ADD CONSTRAINT FK_EF5F196B4B89032C FOREIGN KEY (post_id) REFERENCES post (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE post_seance ADD CONSTRAINT FK_EF5F196BE3797A94 FOREIGN KEY (seance_id) REFERENCES seance (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE post_seance DROP FOREIGN KEY FK_EF5F196B4B89032C');
        $this->addSql('ALTER TABLE post_seance DROP FOREIGN KEY FK_EF5F196BE3797A94');
        ...
        $this->addSql('DROP TABLE post_seance');
